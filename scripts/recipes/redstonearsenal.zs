/*
	Redstone Arsenal recipes script.
...
<redstonearsenal:material:32> : [<contenttweaker:fluxed_electrum_compound>]
};
...
<redstonearsenal:material:128> : {
		"redstonearsenal_material_128_1" : [
			[<redstonearsenal:material:32>, <ore:craftHammer>.transformDamage(10)]
		]
	},
<contenttweaker:fluxed_electrum_compound> : {
        "contenttweaker_fluxed_electrum_compound" :[
            [<redstonearsenal:material>, <ore:sand>]
        ]
    }
};
