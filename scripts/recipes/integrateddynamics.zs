/*
	Integrated Dynamics recipes script.
...
<integrateddynamics:squeezer> : {
		"integrateddynamics_squeezer" : [
			[
	  			[<ore:stickWood>, <ore:blockIron>, <ore:stickWood>],
	   			[<ore:stickWood>, <thermalexpansion:frame>, <ore:stickWood>],
	  			[<ore:ingotIron>, <ore:ingotIron>, <ore:ingotIron>]
			]
		]
	},
<integrateddynamics:drying_basin> : {
		"integrateddynamics_drying_basin" : [
			[
...
// 		"integrateddynamics_energy_battery" : [
// 			[
...
// 	   			[<integrateddynamics:crystalized_menril_chunk>, <ore:blockRedstone>, <integrateddynamics:crystalized_menril_chunk>],
// 	  			[<integrateddynamics:crystalized_menril_chunk>, <thermalexpansion:frame:64>, <integrateddynamics:crystalized_menril_chunk>]
// 			]
// 		]
// 	}
};
