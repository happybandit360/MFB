...
mods.recipestages.Recipes.setRecipeStage("actually_additions", "actuallyadditions_block_misc_9");
mods.recipestages.Recipes.setRecipeStage("actually_additions", "actuallyadditions_item_misc_3");
