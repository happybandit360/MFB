...
mods.orestages.OreStages.addReplacement("metallurgy", <metallurgy:ignatius_ore>, <minecraft:stone>);
...
mods.orestages.OreStages.addReplacement("metallurgy", <metallurgy:shadow_iron_ore>, <minecraft:stone>);
mods.orestages.OreStages.addReplacement("metallurgy", <metallurgy:vulcanite_ore>, <minecraft:stone>);
...
mods.orestages.OreStages.addReplacement("metallurgy", <metallurgy:kalendrite_ore>, <minecraft:stone>);
mods.orestages.OreStages.addReplacement("metallurgy", <metallurgy:lemurite_ore>, <minecraft:stone>);
...
mods.orestages.OreStages.addReplacement("metallurgy", <metallurgy:midasium_ore>, <minecraft:stone>);
